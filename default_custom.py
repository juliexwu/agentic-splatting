"""
Modified version of agentic-splatting/gsplat/gsplat/strategy/default.py.
Replace the file at that path with the contents of this file in order to use this custom implementation.

Added custom cap_max functionality for loosely capping the number of Gaussians, inspired by the agentic-splatting/gsplat/gsplat/strategy/mcmc.py implementation.
"""
